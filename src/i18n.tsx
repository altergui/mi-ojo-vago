...
const STRINGS = {
  es: {
    ...
    'sync.disabledIntro':
      'Llevá tu configuración y estadísticas de un dispositivo a otro con un código, sin cuentas ni contraseñas.',
    'sync.enable': 'Activar sincronización',
    'sync.enabling': 'Activando…',
    'sync.haveCode': '¿Ya tenés un código de otro dispositivo?',
    'sync.codePlaceholder': 'gato-verde-742',
    'sync.link': 'Vincular',
    'sync.linking': 'Vinculando…',
    'sync.invalidCode': 'Ese código no es válido. Revisá que esté bien escrito.',
    'sync.linkError': 'No se pudo conectar. Probá de nuevo.',
    'sync.yourCode': 'Tu código',
    'sync.copy': 'Copiar',
    'sync.copied': '¡Copiado!',
    'sync.scanHint': 'Escaneá este código QR (o escribí el código) en tu otro dispositivo para vincularlo.',
  ...
  en: {
    ...
    'sync.disabledIntro':
      'Carry your settings and stats between devices with a code, no accounts or passwords.',
    'sync.enable': 'Enable sync',
    'sync.enabling': 'Enabling…',
    'sync.haveCode': 'Already have a code from another device?',
    'sync.codePlaceholder': 'cat-green-742',
    'sync.link': 'Link',
    'sync.linking': 'Linking…',
    'sync.invalidCode': "That code isn't valid. Check it's typed correctly.",
    'sync.linkError': "Couldn't connect. Try again.",
    'sync.yourCode': 'Your code',
    'sync.copy': 'Copy',
    'sync.copied': 'Copied!',
    'sync.scanHint': 'Scan this QR code (or type the code) on your other device to link it.',
